 ...
 * cipher type.
 */
export function initCiphTable(table, type, key1 = 0, key2 = 0) {
...
function createTable56(r, keyByte) {
 ...
 * is the identity).
 */
export function decryptBlock(table, block) {
 ...
 */
export function combineAwbKey(key, awbKey) {
    if (!awbKey)
        return key & 0xffffffffffffffffn;
 ...
 */
export function splitKey64(key) {
